...
cusl_city CHAR (17) DEFAULT 'Sylhet',
...
--customers2 Table value Delete Start
delete from customers2;

--customers2 Table Delete Start
...
('P00005','PRANTO','STUDENT','5241.2','45');
...
--Triggering start
create trigger tests on Transactions for insert
as
begin
